            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col items-center lg:items-start gap-4">
                ...
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                  ...
                  <a href="#" target="_blank" rel="noopener noreferrer" className="bg-black hover:bg-zinc-800 text-white px-6 py-3 rounded font-bold text-base transition-all shadow-[0_10px_20px_rgba(0,0,0,0.3)] flex items-center justify-center gap-2 hover:-translate-y-1">
